...
<html lang="zh-CN">
  ...
  <body style="padding:20px; background-color:#eee;">
    ...
    <form role="form" method="post" action="<%=request.getContextPath()%>/business/login" style="width:372px; height:300px; position:absolute; top:50%; left:50%; margin-top:-180px; margin-left:-186px;">
      <div class="form-group" style="text-align:center; padding-bottom:10px;">
      <h4>登录夜程序</h4>
      </div>
      <div class="form-group">
      <label for="mobile">用户名</label>
      <input style="border-radius:3px;" class="form-control" name="mobile" type="text" placeholder="请输入手机号">
      </div>
      <div class="form-group">
      ...
      <div class="text-center"><a href="javascript:;">忘记密码</a> | <a href="<%=request.getContextPath()%>/business/register">注册账号</a></div>
    </form>
  </body>
</html>
