  ...
  <body style="overflow:hidden;">
    <div class="nav navbar-inverse" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example">          
          <ul style="padding:2px;" class="nav navbar-nav navbar-right">
            ...
            <li><a href="<%=request.getContextPath()%>/corporation/logout">退出登录&nbsp;<span class="glyphicon glyphicon-log-out"></span></a></li>
          </ul>          
        </div>
    </div>
    ...
    <!-- <div style="position:relative; min-height:100%; left:0px; bottom:0px;" class="container"> -->
      <div class="left-side-bar" style="z-index:9; position:absolute; top:0px; left:0px; background-color:#eee; width:178px;">
        ...
        <ul class="overview"><a class="item-head" target="main-frame" href="<%=request.getContextPath()%>/corporation/overview"><span class="licon"></span>总览</a>
        </ul>
        <ul class="function"><a class="item-head" href="javascript:;"><span class="licon"></span>商家管理</a>
          <li><a target="main-frame" href="<%=request.getContextPath()%>/corporation/businessManage/businessInfo">商家信息</a></li>
          <li><a target="main-frame" href="<%=request.getContextPath()%>/corporation/businessManage/businessFinance">商家收入情况</a></li>
        </ul>
        <ul class="function"><a class="item-head" href="javascript:;"><span class="licon"></span>代理商管理</a>
          <li><a target="main-frame" href="<%=request.getContextPath()%>/corporation/agencyManage/agencyInfo">代理商信息</a></li>
          <li><a target="main-frame" href="<%=request.getContextPath()%>/corporation/agencyManage/agencyFinance">代理收入情况</a></li>
        </ul>
        <ul class="account"><a class="item-head" href="javascript:;"><span class="licon"></span>账务管理</a>
          <li><a target="main-frame" href="<%=request.getContextPath()%>/corporation/financeManage/revenue">营收情况</a></li>
          <li><a target="main-frame" href="<%=request.getContextPath()%>/corporation/financeManage/cashOutManage">提现管理</a></li>
        </ul>
        <%-- <ul class="account"><a class="item-head" href="javascript:;"><span class="licon"></span>功能设置</a>
          <li><a target="main-frame" href="<%=request.getContextPath()%>/corporation/functionManage/weishangqiangInfo">微上墙</a></li>
        </ul> --%>
      ...
      <div style="z-index:9; position:absolute; top:55px; left:178px; right:0px; bottom:0px;">
        <iframe name="main-frame" src="<%=request.getContextPath()%>/corporation/overview" style="width:100%; height:100%; border-width:0px; overflow-x:hidden;">
        </iframe>
      </div>
  </body>
</html>
