						...
						<ul style="padding: 10px 10px; list-style-type:none;">
							<li class="clearfix">
								<span style="border-right:0px solid #ddd; width:200px; height:80px; display:inline-block; text-align:center; padding:10px;" class="pull-left">
									<span style="font-size:20px;">￥&nbsp;${currentCorporation.balance}</span>
									<br>
									<span style="font-size:12px;">营收总额&nbsp;<a style="color:#1ab700;" href="<%=request.getContextPath()%>/corporation/financeManage/revenue">详情</a></span>
								</span>
