...
<script>
	...
	function update(businessId, notes) {
		if ($("#id").val().length < 1) {
			return alert("商家ID不能为空！");
		}
		if ($("#name").val().length < 1) {
			return alert("商家名称不能为空！");
		}
		if ($("#addrress").val().length < 1) {
			return alert("商家地址不能为空！");
		}
		if ($("#tel").val().length < 1) {
			return alert("商家电话不能为空！");
		}
		if ($("#bank").val().length < 1) {
			return alert("商家开户行不能为空！");
		}
		if ($("#bankPossessor").val().length < 1) {
			return alert("持卡人姓名不能为空！");
		}
		if ($("#bankAccount").val().length < 1) {
			return alert("商家银行卡号不能为空！");
		}
		if ($("#balance").val().length < 1) {
			return alert("商家余额不能为空！");
		}
		if ($("#ratio").val().length < 1) {
			return alert("商家收益比例不能为空！");
		}
