...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div style="position:relative; min-height:100%; left:0px; bottom:0px;" class="container">
      <div class="left-side-bar" style="z-index:9; position:absolute; top:-55px; left:0px; height:700px; background-color:#eee; width:178px;">
        <span style="background:url(<%=request.getContextPath()%>/resource/img/icon_admin_all_bk1.png) 0 0; width:90px; height:36px; display:inline-block; margin:20px 40px;"></span>
        <style>
		  .overview a .licon {
        ...
        <ul class="account"><a class="item-head" href="javascript:;"><span class="licon"></span>账号管理</a>
          ...
          <li><a target="main-frame" href="<%=request.getContextPath()%>/business/accountManage/passwordManage">密码管理</a></li>
        </ul>
      </div>
      <div style="z-index:9; position:absolute; top:0px; left:178px; right:0px; height:645px;">
        <iframe name="main-frame" src="<%=request.getContextPath()%>/business/overview" style="width:100%; height:100%; border-width:0px;">
        </iframe>
      </div>
    </div>
